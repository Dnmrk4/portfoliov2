      ...
      <div className="">
        <div className="flex flex-col justify-center pt-56 ">
          <div className="mx-auto snap-start">
            ...
            <h2 className="flex flex-row p-2 mb-32 text-2xl rounded-full outline outline-offset-1 outline-1">
            <Image src="/assets/dash122.png" alt="" className="w-9 h-9" width={9}
      height={9} />

              About me.</h2>
          </div>
          <div className="container justify-center mx-auto mb-32">
            <p className="max-w-xs mx-auto text-center md:max-w-lg">
        ...
        <div className="flex flex-col justify-center mx-auto mt-32 mb-32">
          ...
          <div className="mx-auto">
            <p className="max-w-sm mx-auto text-center md:max-w-lg">
        ...
        <div className="flex flex-col justify-center mx-auto mt-32 mb-32">
          <div className="mx-auto mb-32">
            <h2 className="text-2xl snap-start">Skills.</h2>
          </div>
          <div className="mx-auto">
            <p className="max-w-xs mx-auto text-center md:max-w-lg">
