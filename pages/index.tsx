          ...
          <div className="">
            ...
            <div className="block md:hidden py-3 px-4 mx-2 opacity-100 dropdown">
              ...
              <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 bg-opacity-95 p-2 shadow bg-base-100 rounded-box w-52">
                <li><a href="/about" className="transition duration-800 hover:text-xl">About</a></li>
                <li><a href="/Experience" className="transition duration-300 hover:text-xl">Experience</a></li>
                <li><a href="/gallery" className="transition duration-300 hover:text-xl">Gallery</a></li>
                <li><a href="/contact" className="transition duration-300 hover:text-xl">Contact</a></li>
